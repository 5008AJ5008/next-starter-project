...
const nextConfig = {
	...
	// --- ДОДАНО КОНФІГУРАЦІЮ ДЛЯ SERVER ACTIONS ---
	serverActions: {
		// Збільшуємо ліміт розміру тіла запиту
		// Наприклад, до 5MB. Vercel Blob на Hobby плані має ліміт близько 4.5MB на один блоб.
		// Встановіть значення, яке трохи більше, ніж максимальний розмір файлу,
		// який ви дозволяєте завантажувати, плюс невеликий запас для інших даних форми.
